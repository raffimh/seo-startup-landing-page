    ...
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">
          With our powerful features, you can take your search engine
          optimization to the next level. Our tools are designed to help you
          optimize your website with ease and efficiency.
        </p>
        ...
        <div className="border border-white/20 p-2.5 rounded-xl mt-3">
          <motion.div
            className="aspect-video bg-cover boder border-white/20 rounded-lg"
            style={{
              backgroundPosition,
              backgroundSize,
